...
if __name__ == '__main__':
    ...
    model = Pipeline([
            ...
            ('classifier', RandomForestClassifier(max_depth=16, n_estimators=20)),
        ])
    ...
    X = training_data[training_size * training_data.shape[0]:, 1]
    y = training_data[training_size * training_data.shape[0]:, 2]
    ...
    test_data = training_data[-((1 - training_size) * training_data.shape[0]):, 1]
    test_data_ground_truth = training_data[-((1 - training_size) * training_data.shape[0]):, 2]
